...
namespace exchange.binance.models
{
    public class Symbol
    {
        [JsonPropertyName("symbol")] public string ID { get; set; }
        ...
        [JsonPropertyName("quotePrecision")] public int QuotePrecision { get; set; }
        ...
        [JsonPropertyName("filters")] public Filter[] Filters { get; set; }
